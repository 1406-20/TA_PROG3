<%@ Page Title="" Language="C#" MasterPageFile="~/EduprogAlumnos.Master" AutoEventWireup="true" CodeBehind="Publicaciones.aspx.cs" Inherits="Eduprog.Publicaciones" %>

<asp:Content ID="PublicacionesTitulo" ContentPlaceHolderID="cphTitulo" runat="server">
    
</asp:Content>

<asp:Content ID="PublicacionesScripts" ContentPlaceHolderID="cphScripts" runat="server">
    <script src="../Scripts/Eduprog/gestionarUsuariosAdmin.js"></script>
</asp:Content>

<asp:Content ID="PublicacionesContenido" ContentPlaceHolderID="cphContenido" runat="server">
       <div class="container">
