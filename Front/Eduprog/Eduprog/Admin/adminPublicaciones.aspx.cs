...
namespace Eduprog
{
    public partial class adminPublicaciones : System.Web.UI.Page
    {
        ...
        private string trash = "<i class='fa-solid fa-trash ps-2'></i>";
        ...
        private void CargarPublicaciones()
        {
            ...
            foreach (EduprogWS.publicaciones post in publicaciones)
            {
                ...
                usuario = daoUsuario.obtenerUsuarioSUperUsuarioPorID(idUsuario);
        ...
        {//<a href='javascript:void(0);' onclick='borrarPublicacion({publicacion.idPublicacion})'>
            ...
            pnlPublicaciones.Controls.Add(literal);
        }
